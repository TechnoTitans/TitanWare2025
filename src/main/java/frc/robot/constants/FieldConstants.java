...
public class FieldConstants {
    ...
    public static class Reef {
        ...
        public enum Level {
            ...
            L1(Units.inchesToMeters(18), 0, new Transform2d(-Units.inchesToMeters(7), 0, Rotation2d.kZero)),
            GROUND_L1(Units.inchesToMeters(18), 0, new Transform2d(-Units.inchesToMeters(2.37), 0, Rotation2d.kZero));
