...
public class Superstructure extends VirtualSubsystem {
    public enum Goal {
        ...
        FLING_NET(Elevator.Goal.NET, ElevatorArm.Goal.STOW, IntakeArm.Goal.ALGAE_FLING, GroundIntakeArm.Goal.STOW),
    ...
    public Superstructure(
        ...
        this.desiresUpwardsMotion = new Trigger(eventLoop, () -> {
            ...
            return (desiredTranslation.getY() >= currentTranslation.getY()
                    || desiredGoal == Goal.L1 || desiredGoal == Goal.PROCESSOR)
                    && !(runningGoal == Goal.L1 && desiredGoal == Goal.STOW)
                    && !(runningGoal == Goal.PROCESSOR && desiredGoal == Goal.STOW);
        });
...
//                .onlyIf(willGroundCollide.negate())
...
//                .onlyIf(willGroundCollide.negate())
    ...
    public void periodic() {
        ...
        Logger.recordOutput(LogKey + "/Triggers/WillCollide", willGroundCollide);
